...
HRESULT Box::CompileShaderFromFile(WCHAR* szFileName, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
	HRESULT hr = S_OK;
...
Box::Box(ID3D11Device*&				g_pd3dDevice,
...
void Box::Render(D3D_DRIVER_TYPE&				g_driverType,
				XMMATRIX&					g_View,
				XMMATRIX&					g_Projection)
{
	...
	XMMATRIX g_World = mScale * mOrbit0 * mTranslate * mOrbit;
	...
	cb.vMeshColor = XMFLOAT4(Colors::Khaki);
	cb.gMaterial.ambient = XMFLOAT4(Colors::White);
	cb.gMaterial.diffuse = XMFLOAT4(0.7f, 0.85f, 0.7f, 1.0f);
